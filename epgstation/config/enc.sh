...
export HOME="/root"
$JLSE -i temp.ts -f true -e true -t cutcm_logo -o " -c:v h264_omx -vf yadif,scale=-2:720 -b:v 8M -aspect 16:9 -r 30000/1001 -c:a aac -ab 192K -ac 2 -bsf:a aac_adtstoasc"
