...
Array.prototype.push.apply(args, ['-c:a', 'aac', '-ab', audioBitrate]);
// 字幕ストリーム設定
Array.prototype.push.apply(args, ['-map', '0:s?', '-c:s', 'ass']);
// 品質設定
Array.prototype.push.apply(args, ['-preset', 'veryfast', '-b:v', '5000k']);
// 出力ファイル
